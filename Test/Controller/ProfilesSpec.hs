    ...
    describe "ProfilesController" do
        ...
        it "renders the profile form with in-place HTMX submission" $ withContext do
            withCleanDb do
                ...
                response `responseBodyShouldContain` "data-bepis-surface-action=\"create-profile-leave-request\""
        ...
        it "keeps profile accordions closed by default and opens explicit sections" $ withContext do
            withCleanDb do
                ...
                response `responseBodyShouldNotContain` "id=\"profile-rsa-collapse\""
        ...
        it "temporarily hides profile RSA section" $ withContext do
            withCleanDb do
