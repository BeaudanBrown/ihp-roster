...
rosterRawRegistry =
    registryWithSurfaces
        [ rawSurfaceWithPrimitives "RosterSurface" "Roster"
            ...
            , raw "SourceRef" [marker "DragSourceRef", promotedList [raw "SessionOption" [marker "DragSession"], raw "Submits" [marker "MoveRosterShiftToSlot"], raw "SourceField" [marker "SourceItemKey"], raw "ModifierVariant" [marker "Copy", marker "DuplicateRosterShiftToDay", promotedList [raw "Effect" [marker "CloneShadowCopy", promotedList [raw "Layer" [marker "DragPreviewLayer"]]], raw "Effect" [marker "DropzoneHighlight", promotedList []]]]]]
