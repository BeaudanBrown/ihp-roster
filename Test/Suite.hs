...
allSuites =
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "BillingController", definitionEstimatedRuntimeSeconds = 1.0, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Billing, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A4, B1, B2], definitionPartialInvariants = []} Test.Controller.BillingSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "BillingWebhook", definitionEstimatedRuntimeSeconds = 0.9, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Billing, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [B4, B5, B7], definitionPartialInvariants = [B6]} Test.BillingWebhookSpec.tests
