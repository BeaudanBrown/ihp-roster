...
import qualified Test.BoundaryUtilitiesSpec
...
import qualified Test.Controller.Exports.WorkbookConfigurationsSpec
import qualified Test.TimesheetSelectionSpec
import qualified Test.TimesheetWageDisplaySpec
...
import qualified Test.Controller.RosterWeeks.NotificationSpec
...
import qualified Test.FeedbackDomainSpec
...
import qualified Test.ManagementModeSpec
...
import qualified Test.PayrollWorkbookConfigurationSpec
import qualified Test.PayrollWorkbookModelSpec
...
import qualified Test.ResendWebhookSpec
...
import qualified Test.TelemetrySpec
import qualified Test.TimePickerSpec
import qualified Test.TimesheetApprovalSpec
import qualified Test.ToggleButtonSpec
import qualified Test.TypedErrorCategorySpec
...
import qualified Test.XeroTimesheetProviderWriteSpec
...
import qualified Test.XeroWageFailureProjectionSpec
...
allSuites :: [TestSuite]
allSuites =
    [ databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "Audit", definitionEstimatedRuntimeSeconds = 0.3, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = DataIntegrityAndAudit, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.AuditSpec.tests
    ...
    , pureSuite SuiteDefinition{definitionLabel = "BoundaryUtilities", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = DataIntegrityAndAudit, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.BoundaryUtilitiesSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "StaticController", definitionEstimatedRuntimeSeconds = 0.2, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = AccessAndOnboarding, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.Controller.StaticSpec.tests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "Billing", definitionEstimatedRuntimeSeconds = 0.5, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Billing, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [B5, B7], definitionPartialInvariants = []} Test.BillingPersistenceSpec.tests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "DatabaseProtection", definitionEstimatedRuntimeSeconds = 1.4, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = DataIntegrityAndAudit, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A6, T6, P5], definitionPartialInvariants = []} Test.DatabaseProtectionSpec.tests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "RosterTemplateApplication", definitionEstimatedRuntimeSeconds = 2.2, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Rostering, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.RosterTemplateApplicationSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "RosterTemplateCaptureController", definitionEstimatedRuntimeSeconds = 1.0, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Rostering, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.Controller.RosterTemplatesSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "RosterTemplateCapture", definitionEstimatedRuntimeSeconds = 1.5, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Rostering, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.RosterTemplateCaptureSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "RosterWeeksController.Navigation", definitionEstimatedRuntimeSeconds = 1.6, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Rostering, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A3, R1], definitionPartialInvariants = []} Test.Controller.RosterWeeks.NavigationSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "RosterWeeksController.Notification", definitionEstimatedRuntimeSeconds = 0.9, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Rostering, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.Controller.RosterWeeks.NotificationSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "RosterWeeksController.Workflow", definitionEstimatedRuntimeSeconds = 7.5, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Rostering, definitionFixtureCost = LargeFixture, definitionExternalMocks = [], definitionOwnedInvariants = [R1, R2, R3, R4], definitionPartialInvariants = []} Test.Controller.RosterWeeks.WorkflowSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "RosterWeeksController.Fragments", definitionEstimatedRuntimeSeconds = 5.0, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Rostering, definitionFixtureCost = LargeFixture, definitionExternalMocks = [], definitionOwnedInvariants = [R1, R4, T4], definitionPartialInvariants = []} Test.Controller.RosterWeeks.FragmentsSpec.tests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "RosterWeeksController.DirectReadModel", definitionEstimatedRuntimeSeconds = 1.1, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Rostering, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [R4, R5], definitionPartialInvariants = []} Test.Controller.RosterWeeks.DirectReadModelSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "LeaveRequestsController", definitionEstimatedRuntimeSeconds = 2.9, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = TimesheetsAndLeave, definitionFixtureCost = LargeFixture, definitionExternalMocks = [], definitionOwnedInvariants = [T3, T4, T5], definitionPartialInvariants = []} Test.Controller.LeaveRequestsSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "FeedbackController", definitionEstimatedRuntimeSeconds = 0.5, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = ProductSupport, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.Controller.FeedbackSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "FeedbackDomain", definitionEstimatedRuntimeSeconds = 0.8, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = ProductSupport, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.FeedbackDomainSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "EmailDelivery", definitionEstimatedRuntimeSeconds = 0.3, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = Communications, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.EmailDeliverySpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "OperationalIncident", definitionEstimatedRuntimeSeconds = 0.5, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = Communications, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.OperationalIncidentSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "ResendWebhook", definitionEstimatedRuntimeSeconds = 0.5, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = Communications, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.ResendWebhookSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "AccountSecurityEmail", definitionEstimatedRuntimeSeconds = 0.5, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = AccessAndOnboarding, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A3, A4], definitionPartialInvariants = []} Test.AccountSecurityEmailSpec.tests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "WorkbookConfigurationRequests", definitionEstimatedRuntimeSeconds = 0.7, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = PayAndExports, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A7, P6], definitionPartialInvariants = []} Test.Controller.Exports.WorkbookConfigurationsSpec.tests
    ...
    , pureSuite SuiteDefinition{definitionLabel = "TimesheetSelection", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = PayAndExports, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.TimesheetSelectionSpec.tests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "PayrollWorkbookConfiguration", definitionEstimatedRuntimeSeconds = 0.5, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = PayAndExports, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [P6], definitionPartialInvariants = []} Test.PayrollWorkbookConfigurationSpec.tests
    , pureSuite SuiteDefinition{definitionLabel = "PayrollWorkbookModel", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = PayAndExports, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [P6], definitionPartialInvariants = []} Test.PayrollWorkbookModelSpec.tests
    ...
    , pureSuite SuiteDefinition{definitionLabel = "TimesheetWageDisplay", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = PayAndExports, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.TimesheetWageDisplaySpec.tests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "WageEngine.MinimumPaymentDataVic", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = PayAndExports, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [P3], definitionPartialInvariants = []} Test.WageEngine.MinimumPaymentSpec.databaseTests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "WageEngine.Adapter", definitionEstimatedRuntimeSeconds = 6.0, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = PayAndExports, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [P1], definitionPartialInvariants = []} Test.WageEngine.AdapterSpec.databaseTests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "WageSourceAlert", definitionEstimatedRuntimeSeconds = 0.6, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Communications, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.WageSourceAlertSpec.tests
    ...
    , pureSuite SuiteDefinition{definitionLabel = "ManagementMode", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = AccessAndOnboarding, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.ManagementModeSpec.tests
    ...
    , pureSuite SuiteDefinition{definitionLabel = "FwcMapdSync.Curation", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = PayAndExports, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.FwcMapdSyncSpec.pureTests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "FwcMapdSync.Persistence", definitionEstimatedRuntimeSeconds = 0.4, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = PayAndExports, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [P3, P5], definitionPartialInvariants = []} Test.FwcMapdSyncSpec.databaseTests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "VenueAccess", definitionEstimatedRuntimeSeconds = 5.0, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = AccessAndOnboarding, definitionFixtureCost = LargeFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A4, A5, A6], definitionPartialInvariants = []} Test.Controller.VenueAccessSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "FixedExportGolden", definitionEstimatedRuntimeSeconds = 7.2, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = PayAndExports, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [P4, P5, P6], definitionPartialInvariants = []} Test.Controller.FixedExportGoldenSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "StaffController", definitionEstimatedRuntimeSeconds = 6.0, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = StaffAndCompliance, definitionFixtureCost = LargeFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A4, P1, T7], definitionPartialInvariants = []} Test.Controller.StaffSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "StaffDocumentsController", definitionEstimatedRuntimeSeconds = 0.4, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = StaffAndCompliance, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A6], definitionPartialInvariants = []} Test.Controller.StaffDocumentsSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "StaffDocumentsRSA", definitionEstimatedRuntimeSeconds = 0.4, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = StaffAndCompliance, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [T6], definitionPartialInvariants = []} Test.StaffDocumentsRsaSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "VenueInvitation", definitionEstimatedRuntimeSeconds = 0.5, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = AccessAndOnboarding, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A1, A4], definitionPartialInvariants = []} Test.VenueInvitationSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "VenueOnboardingInvitation", definitionEstimatedRuntimeSeconds = 0.3, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = AccessAndOnboarding, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [A1, A2], definitionPartialInvariants = []} Test.VenueOnboardingInvitationSpec.tests
    ...
    , pureSuite SuiteDefinition{definitionLabel = "TypedErrorCategories", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = DataIntegrityAndAudit, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.TypedErrorCategorySpec.tests
    ...
    , pureSuite SuiteDefinition{definitionLabel = "MarkupRendering", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = FrontendContractsAndLiveUpdate, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.MarkupRenderingSpec.tests
    ...
    , databaseSuite CleanStateNotRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "OrderedRange.Rendering", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = FrontendContractsAndLiveUpdate, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.OrderedRangeSpec.databaseTests
    , pureSuite SuiteDefinition{definitionLabel = "Overlay.Contract", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = FrontendContractsAndLiveUpdate, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.OverlaySpec.pureTests
    , databaseSuite CleanStateNotRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "Overlay.Rendering", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = FrontendContractsAndLiveUpdate, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.OverlaySpec.databaseTests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "Mail", definitionEstimatedRuntimeSeconds = 0.5, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = Communications, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [B7], definitionPartialInvariants = []} Test.MailSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "RosterNotification", definitionEstimatedRuntimeSeconds = 1.1, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = Communications, definitionFixtureCost = SmallFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.RosterNotificationSpec.tests
    ...
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "XeroTimesheetPreview", definitionEstimatedRuntimeSeconds = 2.3, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = XeroPayroll, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [P5, P6], definitionPartialInvariants = []} Test.XeroTimesheetPreviewSpec.tests
    , pureSuite SuiteDefinition{definitionLabel = "XeroTimesheetProviderWrite", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = XeroPayroll, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [P6], definitionPartialInvariants = []} Test.XeroTimesheetProviderWriteSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityNotRequired SuiteDefinition{definitionLabel = "XeroTimesheetReadiness", definitionEstimatedRuntimeSeconds = 2.9, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = XeroPayroll, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [P5, P6], definitionPartialInvariants = []} Test.XeroTimesheetReadinessSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "TimesheetApproval", definitionEstimatedRuntimeSeconds = 1.0, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = XeroPayroll, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.TimesheetApprovalSpec.tests
    ...
    , pureSuite SuiteDefinition{definitionLabel = "XeroWageFailureProjection", definitionEstimatedRuntimeSeconds = 0.1, definitionFeedbackLane = RoutineCorrectness, definitionInvariantFamily = XeroPayroll, definitionFixtureCost = FixtureFree, definitionExternalMocks = [], definitionOwnedInvariants = [], definitionPartialInvariants = []} Test.XeroWageFailureProjectionSpec.tests
    , databaseSuite BroadCleanStateRequired CommittedVisibilityRequired SuiteDefinition{definitionLabel = "XeroTimesheetReservation", definitionEstimatedRuntimeSeconds = 1.3, definitionFeedbackLane = BroadAcceptance, definitionInvariantFamily = XeroPayroll, definitionFixtureCost = MediumFixture, definitionExternalMocks = [], definitionOwnedInvariants = [P6], definitionPartialInvariants = []} Test.XeroTimesheetReservationSpec.tests
