...
tests = describe "FrontendContract foundation" do
    it "reflects the production migration registry globals" do
        ...
        source `shouldContainText` "export type TimePickerConfig = { rangeStart: string; rangeEnd: string; stepMinutes: number; emptyLabel: string };"
        source `shouldContainText` "export function parseTimePickerConfig(value: unknown): TimePickerConfig"
        source `shouldContainText` "export type TimePickerOption = { value: string; label: string };"
        source `shouldContainText` "export function parseTimePickerOption(value: unknown): TimePickerOption"
        source `shouldContainText` "export const timePickerModalDomId = \"time-picker-modal\" as const;"
        source `shouldContainText` "export const timePickerFieldDomAttr = \"data-bepis-time-picker-field\" as const;"
        source `shouldContainText` "export const timePickerOptionDomAttr = \"data-bepis-time-picker-option\" as const;"
        source `shouldContainText` "export type OrderedRangeCrossingPolicy ="
        source `shouldContainText` "    \"clamp-other-endpoint\";"
        source `shouldContainText` "export type OrderedRangeConfig = { minimumValue: number; maximumValue: number; stepValue: number; defaultStartValue: number; defaultEndValue: number; valueLabels: ReadonlyArray<string>; crossingPolicy: OrderedRangeCrossingPolicy };"
        source `shouldContainText` "export function parseOrderedRangeConfig(value: unknown): OrderedRangeConfig"
        source `shouldContainText` "export type OrderedRangeState = { startValue: number; endValue: number; available: boolean };"
        source `shouldContainText` "export function parseOrderedRangeState(value: unknown): OrderedRangeState"
        source `shouldContainText` "export const orderedRangeClampOtherEndpoint = \"clamp-other-endpoint\" as const;"
        source `shouldContainText` "export const orderedRangeStartPositionProperty = \"--ordered-range-start-position\" as const;"
        source `shouldContainText` "export const orderedRangeEndPositionProperty = \"--ordered-range-end-position\" as const;"
        source `shouldContainText` "export const orderedRangeRootDomAttr = \"data-bepis-ordered-range-root\" as const;"
        source `shouldContainText` "export const orderedRangeStartDomAttr = \"data-bepis-ordered-range-start\" as const;"
        source `shouldContainText` "export const orderedRangeEndDomAttr = \"data-bepis-ordered-range-end\" as const;"
        source `shouldContainText` "export const orderedRangeAvailabilityDomAttr = \"data-bepis-ordered-range-availability\" as const;"
        source `shouldContainText` "export type HorizontalSnapMode ="
        source `shouldContainText` "export type HorizontalSnapConfig = { snapMode: HorizontalSnapMode; itemSelector: string | null; groupCount: number | null; groupProperty: string | null; groupScopeSelector: string | null };"
        source `shouldContainText` "export function parseHorizontalSnapConfig(value: unknown): HorizontalSnapConfig"
        source `shouldContainText` "export type HorizontalDragConfig = { ignoreSelector: string | null };"
        source `shouldContainText` "export const horizontalScrollSnapDomAttr = \"data-bepis-horizontal-scroll-snap\" as const;"
        source `shouldContainText` "export const horizontalScrollDragDomAttr = \"data-bepis-horizontal-scroll-drag\" as const;"
        source `shouldContainText` "export type PasskeySetupPromptMode ="
        source `shouldContainText` "export type PasskeyFlowConfig ="
        source `shouldContainText` "{ tag: \"login\"; beginUrl: string; finishUrl: string; successRedirect?: string; statusKey: string;"
        ...
        source `shouldContainText` "export const passkeyActionButtonDomAttr = \"data-bepis-passkey-action-button\" as const;"
        source `shouldContainText` "export const passkeyDeviceNameDomAttr = \"data-bepis-passkey-device-name\" as const;"
        source `shouldContainText` "export const passkeyStatusDomAttr = \"data-bepis-passkey-status\" as const;"
        source `shouldContainText` "export const passkeyRecoveryDomAttr = \"data-bepis-passkey-recovery\" as const;"
        source `shouldContainText` "export const passkeyDismissalDomAttr = \"data-bepis-passkey-dismissal\" as const;"
        source `shouldContainText` "export const passkeyFlowConfigDomAttr = \"data-bepis-passkey-flow-config\" as const;"
        source `shouldNotContainText` "PublicKeyCredential"
        source `shouldNotContainText` "AuthenticatorAttestationResponse"
        source `shouldNotContainText` "AuthenticatorAssertionResponse"
        source `shouldContainText` "export type PwaInstallState ="
        source `shouldContainText` "  | \"failed\";"
        source `shouldContainText` "export function isPwaInstallState(value: unknown): value is PwaInstallState"
        source `shouldContainText` "export const pwaInstallPageDomAttr = \"data-bepis-pwa-install-page\" as const;"
        source `shouldContainText` "export const pwaInstallButtonDomAttr = \"data-bepis-pwa-install-button\" as const;"
        source `shouldContainText` "export const pwaInstallResultDomAttr = \"data-bepis-pwa-install-result\" as const;"
        source `shouldContainText` "export const pwaInstallResultStateDomAttr = \"data-bepis-pwa-install-result-state\" as const;"
        source `shouldContainText` "export const pwaInstalledStatusDomAttr = \"data-bepis-pwa-installed-status\" as const;"
        source `shouldNotContainText` "BeforeInstallPromptEvent"
        source `shouldNotContainText` "InstallChoice"
        source `shouldContainText` "export type XeroCandidateFilterConfig = { searchProjection: string };"
        source `shouldContainText` "export function parseXeroCandidateFilterConfig(value: unknown): XeroCandidateFilterConfig"
        source `shouldContainText` "export const xeroCandidateFilterRootDomAttr = \"data-bepis-xero-candidate-filter-root\" as const;"
        source `shouldContainText` "export const xeroCandidateFilterSearchDomAttr = \"data-bepis-xero-candidate-filter-search\" as const;"
        source `shouldContainText` "export const xeroCandidateFilterCandidateDomAttr = \"data-bepis-xero-candidate-filter-candidate\" as const;"
        source `shouldContainText` "export const xeroCandidateFilterConfigDomAttr = \"data-bepis-xero-candidate-filter-config\" as const;"
        source `shouldContainText` "export const xeroCandidateFilterEmptyDomAttr = \"data-bepis-xero-candidate-filter-empty\" as const;"
        source `shouldContainText` "export type DialogSubmitConfig = { loadingLabel: string };"
        source `shouldContainText` "export function parseDialogSubmitConfig(value: unknown): DialogSubmitConfig"
        source `shouldContainText` "export type ToastConfig = { autoHideMs: number };"
        source `shouldContainText` "export function parseToastConfig(value: unknown): ToastConfig"
        source `shouldContainText` "export const dialogMountDomAttr = \"data-bepis-dialog-mount\" as const;"
        source `shouldContainText` "export const dialogBackdropDomAttr = \"data-bepis-dialog-backdrop\" as const;"
        source `shouldContainText` "export const dialogCloseDomAttr = \"data-bepis-dialog-close\" as const;"
        source `shouldContainText` "export const dialogDismissedEvent = \"bepis:dialog-dismissed\" as const;"
        source `shouldContainText` "export const dialogSubmitDomAttr = \"data-bepis-dialog-submit\" as const;"
        source `shouldContainText` "export const dialogSubmitConfigDomAttr = \"data-bepis-dialog-submit-config\" as const;"
        source `shouldContainText` "export const dialogAutoSubmitOnceDomAttr = \"data-bepis-dialog-auto-submit-once\" as const;"
