...
`docs/archive/plans/58-xero-connection-foundation.md`, `docs/archive/plans/45-payroll-report-exports.md`,
...
This plan narrows phases 5 and 6 of `docs/archive/plans/57-xero-payroll-integration.md` into
