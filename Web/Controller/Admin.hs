...
instance Controller AdminController where
    ...
    action currentAction@ShowXeroProblemTimesheetApprovalRefreshConfirmationAction { xeroTimesheetPreparationRunId, timesheetEntryId } = runBepis currentAction BepisFormAction do
        ensureVenueWritable
        requireCurrentVenueOwnerForXero (showXeroProblemTimesheetApprovalRefreshConfirmationAction xeroTimesheetPreparationRunId timesheetEntryId)
    ...
    action currentAction@ShowadminXeroTimesheetPreparationWaitLiveFragmentAction = runBepis currentAction BepisFragmentAction $
        profileActionSpan "admin.xero_timesheet_preparation_wait_fragment.respond" do
            requireCurrentVenueOwnerForXero showXeroTimesheetPreparationWaitFragmentAction
