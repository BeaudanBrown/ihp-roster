...
renderRosterTemplateDeleteConfirmation :: (?context :: ControllerContext) => RosterTemplate -> Id RosterGroup -> Int -> Html
renderRosterTemplateDeleteConfirmation template rosterGroupId weekOffset =
