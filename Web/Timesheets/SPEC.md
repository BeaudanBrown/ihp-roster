...
- Staff can manage their own visible entries. Managers can manage entries for
  linked active staff in their venue scope. During founder support
  impersonation, these ownership and role checks use the effective user and
  linked Staff identity; entry-version actors remain the authenticated founder,
  and payload request context records the effective user and impersonation
  session.
- New ad-hoc entries exclude and
