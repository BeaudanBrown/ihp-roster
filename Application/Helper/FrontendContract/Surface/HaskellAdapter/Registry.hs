...
type RegisteredSurfaceFragmentAdapterHomes =
    '[ SurfaceFragmentAdapterHome TimesheetsAdapterFamily Timesheets.TimesheetToolbar
     ...
     , SurfaceFragmentAdapterHome AdminXeroAdapterFamily Admin.AdminXeroPayItemImportWaitFragment
     , SurfaceFragmentAdapterHome AdminXeroAdapterFamily Admin.AdminXeroStaffMappingsWaitFragment
     ]
...
registeredSurfaceActionAdapterRegistrations =
    ...
    , surfaceOperationLocalActionAdapter @RosterAdapterFamily @Roster.ToggleRosterManagerMode allRequestAdapterOperations
    ...
    , surfaceOperationLocalActionAdapter @FeedbackAdapterFamily @Feedback.UnvoteFeedback
        (requestAdapterOperationsWithoutParser "The zero-field unvote consumes its route id and authenticated global account")
