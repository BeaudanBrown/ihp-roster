...
updateProfileShiftPreferencesActionEvidence =
    actionEvidence (SurfaceIR.HtmxActionIR "UpdateProfileShiftPreferences" "update-profile-shift-preferences" [SurfaceIR.FieldIR "SectionField" "section" (SurfaceIR.WireClosedIR "StaffProfileSectionValue" "Application.Helper.FrontendContract.Surface.Profile" "StaffProfileSectionValue") SurfaceIR.RequiredField, SurfaceIR.FieldIR "ShiftPreferenceKeysField" "shiftPreferenceKeys" (SurfaceIR.WireListIR (SurfaceIR.WireTextIR)) SurfaceIR.OptionalFieldPresence] [SurfaceIR.HtmxOption (SurfaceIR.HtmxActionMethodIR SurfaceIR.HtmxPostIR), SurfaceIR.HtmxOption (SurfaceIR.HtmxActionPushUrlIR SurfaceIR.HtmxPushUrlFalseIR), SurfaceIR.HtmxOption (SurfaceIR.HtmxActionCustomHtmxIR "staff-profile-section-htmx-attrs" "profile and staff forms provide their concrete section target and swap modifier at the route boundary")])
