...
- `PayrollWorkbook.hs` — versioned ordered sheet-family definitions, locked Summary/Hours/Wages presentation, the implementation-owned hidden Data worksheet, formulas, typed XLSX cells, formatting, and worksheet primitives.
