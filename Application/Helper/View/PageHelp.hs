...
pageHelpTopics =
    [ topic "roster" "Roster"
        ...
        , section HelpManagerPlus "Planning"
            ...
            , buttonItem HelpManagerPlus "bi-fullscreen" "Side panel" "Expand the roster workspace" "Use the fullscreen-style button at the top right to hide the Staff/Templates/Settings panel temporarily. Use the button again or press Escape while working in the expanded roster to restore the panel." "btn btn-outline-secondary" (Just "bi-fullscreen") ""
