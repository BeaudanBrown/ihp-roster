...
pageHelpTopics =
    ...
    , topic "timesheets" "Timesheets"
        [ section HelpEveryone "Timesheet tasks"
            ...
            , iconItem HelpEveryone "bi-funnel" "Timesheet settings" "Choose what appears" "Open Timesheet settings to toggle Hide approved or Show suggestions. These choices are saved to your account and remain active after navigation or reload."
        ...
        , section HelpManagerPlus "Review tasks"
            [ iconItem HelpManagerPlus "bi-people" "Staff filter" "Review one person or everyone" "Managers see all authorized staff by default. Choose a staff member from Timesheet settings to narrow the current URL to that person."
