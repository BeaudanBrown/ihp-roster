...
pageHelpTopics =
    [ topic "roster" "Roster"
        ...
        , section HelpManagerPlus "Planning"
            [ iconItem HelpManagerPlus "bi-layout-text-window-reverse" "Templates" "Design reusable Day or Week plans" "Create a template blank or from a read-only roster reference. The isolated Template design card autosaves complete changes to your private draft; saving shares the immutable version with roster editors."
