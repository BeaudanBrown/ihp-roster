...
pageHelpTopics =
    [ topic "roster" "Roster"
        ...
        , section HelpManagerPlus "Planning"
            ...
            , buttonItem HelpManagerPlus "bi-sliders" "Settings tab" "Show warnings or wage estimates" "Open Settings in the staff panel, then use the Display controls. Wage estimates use the same Award calculation as draft Timesheets; source warnings and excluded calculation errors appear beside the week total." "btn btn-outline-secondary" (Just "bi-sliders") ""
