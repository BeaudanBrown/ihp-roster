...
pageHelpTopics =
    [ topic "roster" "Roster"
        ...
        , section HelpManagerPlus "Planning"
            ...
            , buttonItem HelpManagerPlus "bi-sliders" "Settings tab" "Show warnings or wage estimates" "Open Settings in the staff panel, then use the Display controls. Wage estimates use the same calculation as draft Timesheets. Roster-only shifts are omitted; calculation errors for Timesheet-producing shifts appear beside the week total. Source-maintenance warnings are visible only to platform super admins. When wages are enabled, pin a staff eye control to filter week and day estimates to that person; unpin to restore venue totals." "btn btn-outline-secondary" (Just "bi-sliders") ""
