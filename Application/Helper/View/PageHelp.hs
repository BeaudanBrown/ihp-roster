...
pageHelpTopics =
    [ topic "roster" "Roster"
        ...
        , section HelpManagerPlus "Planning"
            ...
            , buttonItem HelpManagerPlus "bi-envelope" "Email roster" "Email the live roster" "Open Settings, then Share roster. Confirm the venue, roster group, week, recipient count, skipped count, and latest attempt before queueing delivery. Email roster is unavailable for draft rosters, when nobody is eligible, or while delivery is still in progress." "btn btn-outline-primary" (Just "bi-envelope") "Email roster"
