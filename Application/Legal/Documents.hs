...
defaultLegalDocumentBody businessName supportEmail = \case
    TermsDocument ->
        Text.unlines
            ...
            , ""
            , businessName <> " (ACN 697 629 208) is a company registered in Australia. These terms are governed by the laws of Victoria, Australia."
            , ""
            , businessName <> " provides venue operations software and related support services for hospitality operators, including rostering, timesheets, leave and unavailability workflows, payroll-ready exports, and operational reference data."
            , ""
            ...
            , ""
            , "Subscriptions may be cancelled through the Stripe Customer Portal where available, or by contacting " <> supportEmail <> ". Cancellation stops future renewal, and access ordinarily continues until the end of the current paid billing period unless otherwise agreed."
            , ""
            , "Customers may export available records from the service while they have access. After cancellation, customers may contact " <> supportEmail <> " to request reasonable export or deletion assistance, subject to lawful retention, backup, security, audit, and dispute-handling requirements."
            , ""
            ...
            , ""
            , "The service may use public or licensed reference data, including Fair Work Commission Modern Awards Pay Database material and Victorian public holiday information, to support wage-rate and public-holiday features. Customers remain responsible for checking applicability before using outputs for payroll, compliance, or accounting purposes."
            , ""
    ...
    PrivacyDocument ->
        Text.unlines
            ...
            , "Last updated: 8 May 2026"
            , ""
            , businessName <> " (ACN 697 629 208) collects and handles personal information to provide rostering, timesheet, leave, unavailability, export, onboarding, billing, security, and support services."
            , ""
            ...
            , ""
            , businessName <> " may disclose information to the relevant customer business and its authorised users, service providers that help operate the platform, Stripe for hosted payment and subscription billing services, Xero when a customer enables Xero integrations, professional advisers, and where required or authorised by law."
            , ""
            , "The service may import public or licensed reference data such as Fair Work Commission Modern Awards Pay Database material and Victorian public holiday information. These reference-data imports are used to support service features and are not used as customer-data processors unless a future integration sends personal information to them."
            , ""
            , businessName <> " keeps personal information while needed to provide the service, support customers, maintain security and audit records, resolve disputes, meet legal obligations, and operate backups. When personal information is no longer needed for those purposes, " <> businessName <> " will take reasonable steps to destroy, de-identify, or put it beyond use where lawful and practical."
            , ""
            , "After cancellation, customers may request export or deletion assistance by contacting " <> supportEmail <> ". Some information may be retained where required or permitted for legal, security, backup, audit, or dispute-handling reasons."
            , ""
    ...
    RefundsDisputesDocument ->
        Text.unlines
            ...
            , ""
            , businessName <> " aims to respond to refund and billing dispute requests within 5 business days."
            , ""
    ...
    CancellationDocument ->
        Text.unlines
            ...
            , ""
            , "Cancellation stops future renewal according to the Stripe subscription state and the customer agreement. Access ordinarily continues until the end of the current paid subscription period unless otherwise agreed."
            , ""
            , "Cancellation does not automatically create a refund for unused time in the current paid period. Refund requests are handled under the refund and dispute policy."
            , ""
            , "If a subscription is unpaid or payment fails, " <> businessName <> " may restrict billing-related functionality, request updated payment details, or suspend access according to the customer agreement and operational circumstances."
            , ""
            , "Customers should export any records they need before access ends. Customers may contact " <> supportEmail <> " to request reasonable export or deletion assistance. Some records may be retained after cancellation where required or permitted for legal, audit, backup, dispute, security, or operational reasons."
            , ""
