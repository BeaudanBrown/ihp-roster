...
export type SelfServiceLeaveMountConfig = { surface: "self-service-leave"; scopeKey: string; mountKey: string; fragments: ReadonlyArray<SelfServiceLeaveMountedFragmentConfig>; subscription: { scope: Extract<SurfaceScope, { surface: "self-service-leave" }> } | null };
