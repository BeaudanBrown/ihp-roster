...
export function isInteractionDomAttributes(value: unknown): value is InteractionDomAttributes {
    return __isInteractionDomAttributesExactRecord(value, ["surface", "surfaceFamily", "scopeKey", "mountKey", "sessionDisabled", "sessionReadOnly", "sessionThreshold", "sessionTimeoutMs", "interactionActive", "serverLayer", "disposableLayer", "layer", "conflictPolicies", "intentForm", "intent", "intentField", "fieldPresence", "intentHiddenField"], []) && (typeof value["surface"] === "string") && (typeof value["surfaceFamily"] === "string") && (typeof value["scopeKey"] === "string") && (typeof value["mountKey"] === "string") && (typeof value["sessionDisabled"] === "string") && (typeof value["sessionReadOnly"] === "string") && (typeof value["sessionThreshold"] === "string") && (typeof value["sessionTimeoutMs"] === "string") && (typeof value["interactionActive"] === "string") && (typeof value["serverLayer"] === "string") && (typeof value["disposableLayer"] === "string") && (typeof value["layer"] === "string") && (typeof value["conflictPolicies"] === "string") && (typeof value["intentForm"] === "string") && (typeof value["intent"] === "string") && (typeof value["intentField"] === "string") && (typeof value["fieldPresence"] === "string") && (typeof value["intentHiddenField"] === "string");
}
...
export function isInteractionDomValues(value: unknown): value is InteractionDomValues {
    return __isInteractionDomAttributesExactRecord(value, ["enabled"], []) && (typeof value["enabled"] === "string");
}
...
export function isInteractionDomAttribute(value: unknown): value is InteractionDomAttribute {
    return value === "data-bepis-surface" || value === "data-bepis-surface-family" || value === "data-bepis-scope-key" || value === "data-bepis-mount-key" || value === "data-bepis-session-disabled" || value === "data-bepis-session-read-only" || value === "data-bepis-session-threshold" || value === "data-bepis-session-timeout-ms" || value === "data-bepis-interaction-active" || value === "data-bepis-server-layer" || value === "data-bepis-disposable-layer" || value === "data-bepis-layer" || value === "data-bepis-conflict-policies" || value === "data-bepis-intent-form" || value === "data-bepis-intent" || value === "data-bepis-intent-field" || value === "data-bepis-field-presence" || value === "data-bepis-intent-hidden-field";
}
